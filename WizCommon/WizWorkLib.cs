...
namespace WizCommon
{
    ...
    #region Zebra Printer 연결
    //public class RawPrinterHelper // 2020.10.22 입력
    //{
...
public class WizWorkLib
{
    ...
    public string GetDefaultPrinter()
    {
        ...
        foreach (string printer in PrinterSettings.InstalledPrinters)
        {
            ...
            #region TSC 프린터 사용
            if (settings.IsDefaultPrinter && (printer.Contains("TSC"))) //기본 프린트일때 (프린터 목록 중 TSC가 있을 경우)
            {
                return printer;
            }
            #endregion

            #region Zebra 프린터 사용(서강정밀)
            //if (settings.IsDefaultPrinter && (printer.Contains("ZM400"))) // 제브라 ZT230 모델 / ZM400 모델
            //{
            //    return printer;
            //}
            //#endregion
