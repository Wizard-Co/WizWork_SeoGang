...
namespace WizCommon
{
    ...
    public class DataStore
    {
        ...
        public string[] ExecuteProcedure(string procedureName, Dictionary<string, object> sqlParameter, bool logOn)
        {
            ...
            finally
            {
                if (logOn == true)
                {
                    ...
                    InsertTrxLog(new System.Diagnostics.StackTrace(1, false).GetFrame(0).GetMethod(), trxCommand.ToString(), IsQueryOK, ExMessage);
                }
        ...
        public List<KeyValue> ExecuteAllProcedureOutputGetCS2(List<Procedure> AllProcedure, List<Dictionary<string, object>> sqlParameterall)
        {
            // Output 결과 값을 넣을 List
            List<KeyValue> outputVal = new List<KeyValue>();
            SqlTransaction transaction = null;
