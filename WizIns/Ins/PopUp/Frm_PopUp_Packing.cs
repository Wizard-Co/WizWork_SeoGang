        ...
        private bool LabelPrint(string PackID)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    list_Data.Add(Lib.CheckNull(dr["KCustom"].ToString()));// 품번
                    list_Data.Add(Lib.CheckNull(dr["BuyerArticleNo"].ToString()));// 품번
                    list_Data.Add(Lib.CheckNull(dr["Article"].ToString()));// 품번
                    list_Data.Add(Lib.stringFormatN0(Lib.ConvertDouble(Lib.CheckNull(dr["PackQty"].ToString()))));// 품번
                    list_Data.Add(Lib.DatePickerFormat(Lib.CheckNull(dr["PackDate"].ToString())));// 품번
                    list_Data.Add(Lib.CheckNull(dr["Name"].ToString()));// 품번
                    list_Data.Add(Lib.stringFormatN0(Lib.ConvertDouble(Lib.CheckNull(dr["DefectQty"].ToString()))));// 품번
