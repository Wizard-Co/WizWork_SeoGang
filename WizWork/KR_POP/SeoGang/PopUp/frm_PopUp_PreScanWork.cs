    ...
    public partial class frm_PopUp_PreScanWork : Form
    {
        ...
        private void setDataGrid__ChildArticle()
        {
            ...
            try
            {
                ...
                DataTable dt = DataStore.Instance.ProcedureToDataTable("xp_prdWork_sChildArticleForScan", sqlParameter, false);
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        dgdMain.Rows.Add(++i,
                                                 Lib.CheckNull(dr["CHildArticleID"].ToString()), 
                                                 Lib.CheckNull(dr["BuyerArticleNo"].ToString().Trim()),
                                                 Lib.CheckNull(dr["Article"].ToString().Trim()),
                                                 Lib.CheckNull(stringFormatN3(dr["BomQty"])), // 소요량 NowLoc
