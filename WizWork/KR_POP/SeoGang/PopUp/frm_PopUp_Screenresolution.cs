...
namespace WizWork.POPUP
{
    public partial class frm_tprc_Screenresolution : Form
    {
        ...
        private void btnScreen_Click(object sender, EventArgs e)
        {
            ...
            var openForm = Application.OpenForms.Cast<Form>().FirstOrDefault(f => f is Frm_tprc_Main);
            ...
            {
                Frm_tprc_Main secondForm = new Frm_tprc_Main(true);
                secondForm.Show();
        ...
        private void btnNonScreen_Click(object sender, EventArgs e)
        {
            ...
            {
                Frm_tprc_Main secondForm = new Frm_tprc_Main(false);
                secondForm.Show();
